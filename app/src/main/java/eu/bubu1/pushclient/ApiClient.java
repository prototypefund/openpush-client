...
import eu.bubu1.pushclient.auth.HttpBasicAuth;
import eu.bubu1.pushclient.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public ApiClient(String uri) {
    ...
    createDefaultAdapter(uri);
  }

  public ApiClient(String uri, String[] authNames) {
    this(uri);
    for(String authName : authNames) {
      Interceptor auth;
      if ("basic_auth".equals(authName)) {
        auth = new HttpBasicAuth();
      } else if ("client_key".equals(authName)) {
        auth = new ApiKeyAuth("header", "X-Openpush-Key");
      } else if ("routing_token".equals(authName)) {
        auth = new ApiKeyAuth("header", "X-Openpush-Key");
      } else {
   ...
   */
  public ApiClient(String uri, String authName) {
    this(uri, new String[]{authName});
  }
   ...
   */
  public ApiClient(String uri, String authName, String apiKey) {
    this(uri, authName);
    this.setApiKey(apiKey);
  }

  /**
   * Helper constructor for single basic auth
   * @param uri Server uri
   * @param authName Authentication name
   * @param username Username
   * @param password Password
   */
  public ApiClient(String uri, String authName, String username, String password) {
    this(uri, authName);
